...
def main():
    ...
    with tab1:  # Dashboard
        ...
        if 'scan_results' not in st.session_state:
            ...
            st.image("https://via.placeholder.com/800x400?text=Stock+Scanner+Dashboard+Preview", use_column_width=True)
        else:
            ...
            if trade_plans:
                ...
                st.dataframe(
                    trade_df.style.applymap(highlight_direction, subset=['Direction']),
